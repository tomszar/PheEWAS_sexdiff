...
class NhanesClean:
    ...
    def create_survey_design(self):
        """
        Create survey design from clarite.survey.SurveyDesignSpec
...
class PHE_EWAS:
    ...
    def __init__(self,
        ...
        self.suffixes: list of str
            names to distinguish between different results
        self.converged: list of int
            number of tests that converged
        self.not_converged: list of int
    ...
    def apply_decision_tree(self):
        ...
        # CLASSIFICATION
        # 1. Significant, both meta female and meta male are significant,
        # and betas are opposite
        ...
        # 2. Overall nominal significance, zdiff significance bonferroni,
        # both significant and same direction
        ...
        # 3. Overall nominal significance, zdiff significance boferroni,
